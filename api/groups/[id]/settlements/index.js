...
import { calculateSettlements } from '../../../_logic/settlements';
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        try {
            ...
            const settlements = calculateSettlements(Object.values(balances), group.budgetCurrency, group.familyGroupingEnabled);
